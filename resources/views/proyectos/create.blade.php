        ...
        <div class="col m8" style="background:#f5f6fa;height:40em">
            <form class="form-horizontal" method="POST" action="{{ route('proyectos.store') }}" enctype="multipart/form-data">
                ...
                <div class="col s12 offset-m2 m8" style="margin-top: 10em;">
                        ...
                        <div class="col s12">
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                <input id="comentario" type="text" class="validate" name="comentario" required>
                    ...
                    <button type="submit" style="border-radius:.6em;padding:1em 2em;background:#ede9fe;color:#6d28d9;font-weight:bold;putline:none;border:2px dashed grey;">Crear</button>
                  </div>
                </form>
            </div>
